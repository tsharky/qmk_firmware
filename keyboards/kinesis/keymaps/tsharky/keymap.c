...
#define BONE_US_BASE 0
#define BONE_US_SHIFT 1
#define BONE_US_SYMBOLS 2
#define BONE_US_NAVIGATION 3
#define BONE_US_LAYER5 4
#define BONE_US_LAYER6 5
#define BONE_DE_BASE 6
#define BONE_DE_SHIFT 7
#define BONE_DE_SYMBOLS 8
#define BONE_DE_NAVIGATION 9
...
#define LS_US_LAYER2_MOD3 MO(BONE_US_LAYER5)
#define LS_US_LAYER3_LSFT MO(BONE_US_LAYER5)
#define LS_US_LAYER3_RSFT MO(BONE_US_LAYER5)
#define LS_US_LAYER3_MOD4 MO(BONE_US_LAYER6)
#define LS_US_LAYER4_MOD3 MO(BONE_US_LAYER6)
#define LS_US_LAYER4_MOD4 XXXXXXX
...
#define LS_DE_LAYER2_MOD3 XXXXXXX
#define LS_DE_LAYER3_LSFT XXXXXXX
#define LS_DE_LAYER3_RSFT XXXXXXX
#define LS_DE_LAYER3_MOD4 XXXXXXX
#define LS_DE_LAYER4_MOD3 XXXXXXX
#define LS_DE_LAYER4_MOD4 XXXXXXX
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BONE_US_SHIFT] = LAYOUT(
        ...
        _______, ALGR(US_SCLN), ALGR(US_S), XXXXXXX, XXXXXXX, XXXXXXX,
    ...
    [BONE_US_SYMBOLS] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, US_SUP1, US_SUP2, US_SUP3, XXXXXXX, XXXXXXX,
        ...
        _______, _______,
        XXXXXXX,
        _______, LS_US_LAYER3_RSFT, LS_US_LAYER3_MOD4,
        _______, _______, _______, _______, _______, _______, _______, _______, _______,
        US_CENT, US_YEN, US_COMM, US_LSQU, US_RSQU, _______,
        ...
        _______, _______,
        XXXXXXX,
        LS_US_LAYER3_MOD4, LS_US_LAYER3_RSFT, _______
    ),
    ...
    [BONE_US_NAVIGATION] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______,
        US_PND, US_CURR, KC_TAB, KC_PSLS, KC_PAST, _______,
        US_IEXL, KC_P7, KC_P8, KC_P9, KC_PPLS, KC_PMNS,
        US_IQUE, KC_P4, KC_P5, KC_P6, KC_COMM, KC_PDOT,
    ...
    [BONE_DE_SHIFT] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, DE_CIRC, DE_3, XXXXXXX, XXXXXXX, XXXXXXX,
        _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______,
    ...
    [PROGRAM] = LAYOUT(
        XXXXXXX, DF(BONE_US_BASE), DF(BONE_DE_BASE), DF(QWERTY_BASE), DF(DVORAK_BASE), UC_MAC, UC_LINX, UC_WIN, XXXXXXX,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
